...
- [claude-code-hooks](https://github.com/yurukusa/claude-code-hooks) by [yurukusa](https://github.com/yurukusa) - 10 production hooks and 5 operational templates from 108 hours of autonomous Claude Code operation. Includes context window monitoring with graduated alerts, syntax checking after edits, branch protection, error-aware gates that block pushes when errors exist, and a no-ask-human hook for unattended operation. Each hook exists because something went wrong without it. Covers 18 of 20 checks in [cc-health-check](https://github.com/yurukusa/cc-health-check).
