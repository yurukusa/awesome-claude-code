...
- [Claude Code Ops Starter](https://github.com/yurukusa/claude-code-ops-starter) by [yurukusa](https://github.com/yurukusa) - 4 bash hooks for autonomous Claude Code sessions: context monitoring with staged warnings, autonomous decision enforcement (blocks AskUserQuestion), post-edit syntax verification, and destructive command detection. One-command install, zero dependencies, safe uninstall.
